...
export default function SignUpPage() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-[radial-gradient(circle_at_50%_0%,rgba(20,184,166,0.24),transparent_34%),linear-gradient(135deg,#07100f,#0d1f22)] px-6 text-foreground-legacy">
