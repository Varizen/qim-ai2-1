    ...
    <main className="min-h-screen bg-background-legacy text-foreground-legacy flex flex-col items-center justify-center px-6">
      ...
      {verifying ? (
        <>
          ...
          <p className="text-foreground-legacy/50">Verifying your payment...</p>
        </>
      ) : (
        <>
          ...
          <h1 className="text-3xl font-bold bg-gradient-to-r from-[#14B8A6] to-primary bg-clip-text text-transparent mb-3">
            {verified ? "Payment Successful!" : "Payment Verification"}
          </h1>
          <p className="text-foreground-legacy/50 max-w-md text-center mb-8">
            {verified
      ...
      <footer className="absolute bottom-6 text-center text-xs text-foreground-legacy/20 space-y-1">
        <p>
