/**
 * QiM-AI2.1 — Effect Tokens
 * ========================
 * Spacing, radius, shadows, and transitions.
 */
...
export const shadows = {
  ...
  DEFAULT: "0 1px 3px 0 rgba(0, 0, 0, 0.35), 0 1px 2px -1px rgba(0, 0, 0, 0.35)",
  ...
  "2xl": "0 25px 50px -12px rgba(0, 0, 0, 0.60)",
  inner: "inset 0 2px 4px 0 rgba(0, 0, 0, 0.30)",
  glow: "0 0 40px rgba(109, 93, 252, 0.15)",
  goldGlow: "0 0 40px rgba(242, 199, 102, 0.12)",
} as const;
